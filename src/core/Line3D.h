...
public:
	std::shared_ptr<Point3D<float, char>> pp1;
	std::shared_ptr<Point3D<float, char>> pp2;

	Line3D();
	Line3D(const Point3D<float, char>& p1, const Point3D<float, char>& p2);
	Line3D(std::shared_ptr<Point3D<float, char>> pp1, std::shared_ptr<Point3D<float, char>> pp2);
