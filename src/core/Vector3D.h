...
public:
	Vector3D();
	Vector3D(const Point3D<float, char>& p2);
	Vector3D(const Point3D<float, char>& p1, const Point3D<float, char>& p2);
	Vector3D(std::shared_ptr<Point3D<float, char>> pp1, std::shared_ptr<Point3D<float, char>> pp2);
	Vector3D(std::shared_ptr<Point3D<float, char>> pp1, const Point3D<float, char>& p2);
	Vector3D(const Point3D<float, char>& p1, std::shared_ptr<Point3D<float, char>> pp2);
