...
std::string Particle3D::to_string(const bool& spread, const bool& full_info) const {
...
void Particle3D::print(const bool& spread, const unsigned int& indent, const bool& full_info) const {
	printTabs(indent);
