...
std::string LSN::to_string(const bool& spread, const bool& full_info) const {
...
void LSN::print(const bool& spread, const unsigned int& indent, const bool& full_info) const {
	printTabs(indent);
