/*
 * Displayable.test.cpp
 *
 *  Created on: 7 mai 2024
 *      Author: esn
 */

#ifndef DISPLAYABLE_TEST_CPP_

#define DISPLAYABLE_TEST_CPP_

#include <string.h>
#include "../src/display/Displayable.hpp"

#include <boost/test/unit_test.hpp>

BOOST_AUTO_TEST_SUITE (Displayable_test) // The name of this serie is Displayable_test


BOOST_AUTO_TEST_CASE (test_constructor) { // 
	Displayable<SN<float, char>> dis;
