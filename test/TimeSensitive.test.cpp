/*
 * TimeSensitive.test.cpp
 *
 *  Created on: 7 mai 2024
 *      Author: esn
 */

#ifndef TIMESENSITIVE_TEST_CPP_

#define TIMESENSITIVE_TEST_CPP_

#include <string.h>
#include "../src/core/TimeSensitive.hpp"

#include <boost/test/unit_test.hpp>

BOOST_AUTO_TEST_SUITE (TimeSensitive_test) // The name of this serie is TimeSensitive_test
